...
Click to [`Download LaraDumps v3.2.3`](https://github.com/laradumps/app/releases/download/v3.2.3/LaraDumps-3.2.3-universal.dmg) Apple Disc Image (.dmg) for macOS.
...
Click to [`Download LaraDumps v3.2.3`](https://github.com/laradumps/app/releases/download/v3.2.3/LaraDumps-Setup-3.2.3.exe) installer for Windows.
...
Click to [`Download LaraDumps v3.2.3`](https://github.com/laradumps/app/releases/download/v3.2.3/LaraDumps-3.2.3.AppImage) application image for Linux.
...
```shell
chmod u+x ./LaraDumps-3.2.3.AppImage && ./LaraDumps-3.2.3.AppImage
```
