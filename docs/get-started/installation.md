...
Click to [`Download LaraDumps v3.2.4`](https://github.com/laradumps/app/releases/download/v3.2.4/LaraDumps-3.2.4-universal.dmg) Apple Disc Image (.dmg) for macOS.
...
Click to [`Download LaraDumps v3.2.4`](https://github.com/laradumps/app/releases/download/v3.2.4/LaraDumps-Setup-3.2.4.exe) installer for Windows.
...
Click to [`Download LaraDumps v3.2.4`](https://github.com/laradumps/app/releases/download/v3.2.4/LaraDumps-3.2.4.AppImage) application image for Linux.
...
```shell
chmod u+x ./LaraDumps-3.2.4.AppImage && ./LaraDumps-3.2.4.AppImage
```
